...
            style={{ position: 'absolute', top: '1.2rem', right: '1.2rem', background: 'none', border: 'none', fontSize: '2rem', color: '#e74c3c', cursor: 'pointer', zIndex: 10 }}
...
                      );
                    }
                    console.log('Skill selecionada para sugestão:', skillObj);
