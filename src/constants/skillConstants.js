...
export const SKILL_LEVELS = [
  { value: 'Iniciante/Básico', label: 'Iniciante/Básico' },
  { value: 'Intermediário', label: 'Intermediário' },
  { value: 'Avançado', label: 'Avançado' }
];

export const FORM_PLACEHOLDERS = {
  skillDescription: 'Descreva sua experiência com esta skill...',
  imageUrl: 'https://exemplo.com/imagem.png',
  skillName: 'Nome da skill...'
};

export const MESSAGES = {
  loading: 'Carregando suas skills...',
  noSkills: 'Você ainda não tem nenhuma skill. Adicione uma para começar!',
  deleteConfirm: 'Tem certeza que deseja excluir esta skill?',
